 	...
 	<body class="login" style="background-color:#607D8B;margin-top:2px;">
 		<div class="row">
 			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
 				...
 				<h2 style=" color:white; padding: 15px; font-weight: 900;"><a href="../../../index.html">MediAid <br></a> Reset Password</h2>
 				</div>
               ...
               <a href="../sign-in-up.php" class="cncl">
                 Cancel
			 		...
			 		<div class="copyright" style="font-size:25px; color: floralwhite; text-align: center">
 						&copy; <span class="current-year"></span> By <span class="text-bold text-uppercase">MediAid</span> team. <span>All Rights Reserved</span>
 					</div>
 		</div>
