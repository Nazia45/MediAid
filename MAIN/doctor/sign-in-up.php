...
if($query){
	...
	http://localhost/MediAid/MAIN/doctor/forMail/activate.php?token=$token";
	$sender_email = "From: nazia.project24@gmail.com";
	...
	if($count){
		...
		if($count2>0){
			$_SESSION['errmsg']="Your account is not activated.";
				...
				$body = "Hi Doctor $fname. Click here to reset your password
				http://localhost/MediAid/MAIN/doctor/forMail/resetpass.php?token=$token";
				$sender_email = "From: nazia.project24@gmail.com";
