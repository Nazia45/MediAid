...
<nav>
						...
						<ul class="main-navigation-menu">
							...
							<li>
								<a href="appointment-history.php" style="color: #007AFF">
									<div class="item-content">
									<div class="item-media">
								...
								<li>
								<a href="prescription.php" style="color: #007AFF">
									<div class="item-content">
										<div class="item-media">
								...
								<ul class="sub-menu">
									...
									<li>
										<a href="prescriptionlist.php">
											<span class="title"> Prescription List</span>
										</a>
									</li>
								...
								<li>
								<li>
								<a href="manage-users.php" style="color: #007AFF">
									<div class="item-content">
										<div class="item-media">
								...
								<ul class="sub-menu">
									...
									<li>
										<a href="prescriptionlist.php">
											<span class="title"> My Patients List</span>
										</a>
									</li>
								...
								<li>
								<a href="blogpost.php" style="color: #007AFF">
									<div class="item-content">
										<div class="item-media">
											<i class="fa fa-user-md" style="font-size:25px;"></i>
										</div>
