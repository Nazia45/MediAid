...
<section class="total-bdy" style="margin-top:-15px;">
      <header>
          <a href="../index.html" class="logo"><h2 style="margin:00;">MediAid</h2> A online medical service platform</a>
                  ...
                  <div class="col span_1_of_3">
                      <div class="company_address">
                        <h2 class="c-black">Dear Sir/Mam</h2>
                            ...
                            <p class="c-black">To stay with MediAid, many many thanks to you.</p>
                      <p class="c-black">Email: <span>nazia.nuzhat24@gmail.com</span></p>
