...
if(isset($_GET['sid'])){
  ...
  {
  	// $appdate=$_GET["appdate"];
		header("location:DocTime.php?appdate=$appdate");
  }
}
										...
										<div class="col-lg-12 col-md-12">
											...
											<div class="panel panel-white" style="padding:20px 20px;">
												<!-- <div class="panel-heading"> -->
													<h5 class="panel-title">My times</h5>  <a href="DocDate.php" class="btn btn-o btn-primary" style="float:right; border:2px solid blue">Pick another date</a><br>
												<!-- </div> -->
				...
				?>
						...
						<td><?php echo$row['Endtime'];?></td>
							...
							if(mysqli_num_rows($check_q) == 0)
								{
									?>
								<a href="DocTime.php?sid=<?php echo $row12['Sid'];?>&appdate=<?php echo $appdate;?>" class="btn btn-transparent btn-xs tooltips" title="take time" tooltip-placement="top" tooltip="Remove">Take</a>
<?php
						}
						else{
							?>
