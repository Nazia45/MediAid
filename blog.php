...
<section class="total-bdy">
      <header>
          <a href="index.html" class="logo" style="color: black;"><h2 style="color: black;">MediAid</h2><span style="font-size:20px">A online medical service platform</span></a>
      ...
      <?php
		...
		session_start();
					...
					include('MAIN/doctor/Post.php');
					include('MAIN/doctor/User.php');
