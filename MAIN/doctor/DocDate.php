...
<?php include('include/sidebar-menu.php');?>
			<div class="app-content">
				...
				<div class="main-content" >
					...
					<form role="form"  autocomplete="off" id= "setdate" name="book" method="post" >
                ...
                <!-- <a href="st1.php?appdate=<?php //echo $appdate;?>" class="btn btn-transparent btn-xs tooltips" title="take time" tooltip-placement="top" tooltip="Remove">Sure?</a> -->
